...
public class ModItems {
	...
	public static final ItemSeeds CINDERMOTE_SEEDS = new ItemCindermoteSeeds();
	public static final ItemSeeds SHIMMERPETAL_BULB = new ItemShimmerpetalBulb();
	public static final ItemSeeds VISCAP_SPORES = new ItemViscapSpores();
